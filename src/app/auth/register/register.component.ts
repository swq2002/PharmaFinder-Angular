...
export class RegisterComponent implements OnInit {
  ...
  constructor(public home: HomeService, private fb: FormBuilder, private http: HttpClient, private el: ElementRef,
    private renderer: Renderer2, private router: Router, private toastr: ToastrService, private spinner: NgxSpinnerService, public auth: AuthService, private socialAuthService: SocialAuthService) {
  }
